...
const Landing = () => {
    return (
        <div className="font-sans font-light antialiased overflow-x-hidden selection:bg-indigo-500 selection:text-white bg-[#f8fafc] text-[#0f172a] min-h-screen relative">
            ...
            <nav className="fixed w-full z-50 top-0 start-0 border-b border-white/20 backdrop-blur-md bg-white/70">
            ...
            <section className="py-20 px-4 max-w-7xl mx-auto">
                <div className="text-center mb-16">
                    <h2 className="text-3xl md:text-4xl font-light text-slate-900 mb-4">Un modèle transparent.</h2>
                    <p className="text-slate-500">Choisissez la vitesse de votre croissance.</p>
                </div>

                <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">

                    <div className="p-8 rounded-3xl border border-slate-200 bg-white hover:border-indigo-200 transition-all group">
                        <h3 className="text-lg font-medium text-slate-500 mb-2">Basic</h3>
                        <div className="flex items-baseline gap-1 mb-6">
                            <span className="text-4xl font-normal text-slate-900">49€</span>
                            <span className="text-slate-400">/mois</span>
                        </div>
                        <ul className="space-y-4 mb-8 text-sm text-slate-600">
                            <li className="flex items-center gap-3"><svg className="w-5 h-5 text-indigo-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" /></svg> Dashboard temps réel</li>
                            <li className="flex items-center gap-3"><svg className="w-5 h-5 text-indigo-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" /></svg> Copilote IA (Standard)</li>
                            <li className="flex items-center gap-3"><svg className="w-5 h-5 text-indigo-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" /></svg> Accès financement (Commission 1%)</li>
                        </ul>
                        <button className="w-full py-3 rounded-xl border border-slate-200 text-slate-600 hover:border-indigo-500 hover:text-indigo-600 transition">Commencer</button>
                    </div>

                    <div className="relative p-8 rounded-3xl border border-indigo-500 bg-slate-900 text-white shadow-2xl shadow-indigo-500/20 transform md:-translate-y-4">
                        <div className="absolute top-0 right-0 bg-gradient-to-r from-indigo-500 to-pink-500 text-white text-[10px] font-bold px-3 py-1 rounded-bl-xl rounded-tr-2xl uppercase tracking-wider">Populaire</div>

                        <h3 className="text-lg font-medium text-indigo-200 mb-2">Pro</h3>
                        <div className="flex items-baseline gap-1 mb-6">
                            <span className="text-4xl font-normal text-white">89€</span>
                            <span className="text-slate-400">/mois</span>
                        </div>
                        <ul className="space-y-4 mb-8 text-sm text-slate-300">
                            <li className="flex items-center gap-3"><span className="bg-indigo-500/20 p-1 rounded-full text-indigo-400">✓</span> Prévisions IA étendues (90j)</li>
                            <li className="flex items-center gap-3"><span className="bg-indigo-500/20 p-1 rounded-full text-indigo-400">✓</span> Alertes Proactives</li>
                            <li className="flex items-center gap-3 text-white font-medium"><span className="bg-pink-500/20 p-1 rounded-full text-pink-400">✓</span> Financement à prix coûtant (0%)</li>
                            <li className="flex items-center gap-3 text-white font-medium"><span className="bg-pink-500/20 p-1 rounded-full text-pink-400">✓</span> Placement Trésorerie</li>
                        </ul>
                        <button className="w-full py-3 rounded-xl bg-gradient-to-r from-indigo-600 to-purple-600 text-white hover:shadow-lg hover:shadow-indigo-500/40 transition font-medium">Passer Pro</button>
                    </div>
                </div>
            </section>
        </div>
